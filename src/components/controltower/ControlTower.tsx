    ...
    <Layout className="h-screen">
      ...
      >
        ...
        >
          ...
          >
            <MenuItem key="price-query">运价查询</MenuItem>
            <MenuItem key="price-inquiry">询价管理</MenuItem>
          </SubMenu>
          <SubMenu
            key="order"
            title={
        ...
        <Header className="bg-white h-16 border-b border-gray-200 px-6 flex items-center justify-between">
          <div className="flex items-center">
            ...
            <Breadcrumb>
              ...
              <Breadcrumb.Item>控制塔系统</Breadcrumb.Item>
            ...
            <div className="mb-5">
              ...
              <div className="grid grid-cols-4 gap-2">
                ...
                <Button 
                  ...
                  icon={<IconSettings style={{ color: '#00B42A' }} />}
                >
                  智能运价
                </Button>
                <Button 

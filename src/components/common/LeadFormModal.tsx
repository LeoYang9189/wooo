      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 md:p-0">
          ...
          >
            ...
            {/* 弹窗标题 */}
            <div className="bg-gradient-to-r from-primary to-secondary text-white py-6 px-8 rounded-t-xl">
              <h2 className="text-2xl font-bold">免费试用申请</h2>
              <p className="mt-1 text-white/80">填写以下信息，我们的顾问将尽快与您联系</p>
            </div>
              ...
              <form onSubmit={handleSubmit} className="p-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="col-span-1">
                    ...
                    <input
                      ...
                      className={`w-full px-3 py-2 border ${errors.name ? 'border-red-500' : 'border-gray-300'} rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary`}
                      placeholder="请输入您的姓名"
                    />
                  ...
                  <div className="col-span-1">
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      className={`w-full px-3 py-2 border ${errors.company ? 'border-red-500' : 'border-gray-300'} rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary`}
                      placeholder="请输入公司名称"
                    />
                ...
                <div className="mt-8">
                  <button
                    ...
                    className="w-full flex justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-gradient-to-r from-primary to-secondary hover:from-primary/90 hover:to-secondary/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary transition-all duration-300 relative"
                  >
                    {isSubmitting ? (
                      <>

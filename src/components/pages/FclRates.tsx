...
const FclRates: React.FC = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      dataIndex: 'remark',
      width: 150,
      render: (value: string) => <span>{value || 'LSE已含'}</span>,
    },
    {
      title: '操作',
          ...
          <div className="flex items-center">
            ...
            <Dropdown
              droplist={
                <Menu>
                  <Menu.Item key="info">
                    <IconUser className="mr-2" />个人信息
                  </Menu.Item>
                  <Menu.Item key="setting">
                    <IconSettingsOutline className="mr-2" />账户设置
                  </Menu.Item>
                  <Menu.Item key="help">
                    <IconQuestionCircle className="mr-2" />帮助中心
                  </Menu.Item>
                  <Divider style={{ margin: '4px 0' }} />
                  <Menu.Item key="logout">
                    <IconPoweroff className="mr-2" />退出登录
                  </Menu.Item>
                </Menu>
              }
              position="br"
